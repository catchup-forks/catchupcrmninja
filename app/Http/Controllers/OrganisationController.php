...
class OrganisationController extends BaseController
{
  ...
  public function showSection($section = false)
  {
    ...
    } elseif ($section == ORGANISATION_CUSTOMER_PORTAL) {
      return self::showCustomerPortal();
  ...
  */
  ...
  private function showCustomerPortal()
  {
    $organisation = Auth::user()->organisation->load('country');
    ...
    $data = [
      ...
      'section' => ORGANISATION_CUSTOMER_PORTAL,
      'organisation' => $organisation,
    ];
    return View::make("organisations.customer_portal", $data);
  }
  ...
  private function saveRelationPortal()
  {
    ...
    if ((Utils::isNinja() && Auth::user()->organisation->isPro()) || Auth::user()->organisation->isWhiteLabel()) {
      ...
      $organisation->enable_customer_portal = !!Input::get('enable_customer_portal');
    ...
    return Redirect::to('settings/' . ORGANISATION_CUSTOMER_PORTAL);
  }
