...
@section('content')
    @parent
    @include('organisations.nav', ['selected' => ORGANISATION_TEMPLATES_AND_REMINDERS, 'advanced' => true])
            ...
            <div class="row">
                <div role="tabpanel">
                    ...
                    <div class="tab-content">
                        @include('organisations.template', ['field' => 'invoice', 'active' => true])
                        @include('organisations.template', ['field' => 'quote'])
                        @include('organisations.template', ['field' => 'payment'])
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="panel-body">
            <div class="row">
                <div role="tabpanel">
                    ...
                    <div class="tab-content">
                        @include('organisations.template', ['field' => 'reminder1', 'isReminder' => true, 'active' => true])
                        @include('organisations.template', ['field' => 'reminder2', 'isReminder' => true])
                        @include('organisations.template', ['field' => 'reminder3', 'isReminder' => true])
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function processVariables(str) {
            ...
            var passwordHtml = "{!! $organisation->isPro() && $organisation->enable_portal_password && $organisation->send_portal_password?'<p>'.trans('texts.password').': 6h2NWNdw6<p>':'' !!}";
            var vals = [
