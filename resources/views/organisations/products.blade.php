...
@section('content') 
  ...
  @include('organisations.nav', ['selected' => ORGANISATION_PRODUCTS])

  {!! Former::open()->addClass('warn-on-exit') !!}
  {{ Former::populateField('fill_products', intval($organisation->fill_products)) }}
  {{ Former::populateField('update_products', intval($organisation->update_products)) }}
