...
@section('content')	
	@parent
    @include('organisations.nav', ['selected' => ORGANISATION_INVOICE_DESIGN, 'advanced' => true])
  ...
  <script>
    ...
    function getPDFString(cb) {
      ...
      invoice.organisation.hide_quantity = $('#hide_quantity').is(":checked");
      invoice.organisation.hide_paid_to_date = $('#hide_paid_to_date').is(":checked");
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      {!! Former::populateField('hide_quantity', intval($organisation->hide_quantity)) !!}
      {!! Former::populateField('hide_paid_to_date', intval($organisation->hide_paid_to_date)) !!}
      {!! Former::populateField('all_pages_header', intval($organisation->all_pages_header)) !!}
      {!! Former::populateField('all_pages_footer', intval($organisation->all_pages_footer)) !!}
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="headerFooter">
                    ...
                    {!! Former::inline_radios('all_pages_header')
                            ...
                            ])->check($organisation->all_pages_header) !!}
                    ...
                    {!! Former::inline_radios('all_pages_footer')
                            ...
                            ])->check($organisation->all_pages_footer) !!}
