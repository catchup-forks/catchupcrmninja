...
@section('content') 
    @parent
    @include('organisations.nav', ['selected' => ORGANISATION_EMAIL_SETTINGS, 'advanced' => true])

    {!! Former::open()->rules([
            'iframe_url' => 'url'
        ])->addClass('warn-on-exit') !!}
    {{ Former::populate($organisation) }}
    {{ Former::populateField('pdf_email_attachment', intval($organisation->pdf_email_attachment)) }}
    {{ Former::populateField('enable_email_markup', intval($organisation->enable_email_markup)) }}
        ...
        <div class="panel-body form-padding-right">
            ...
            @if (Utils::isNinja())
                {!! Former::inline_radios('custom_invoice_link')
                        ...
                        ])->check($organisation->iframe_url ? 'website' : 'subdomain') !!}
