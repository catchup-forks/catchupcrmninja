...
@section('content') 
    ...
    {{ Former::populateField('military_time', intval($organisation->military_time)) }}
    {{ Former::populateField('show_currency_code', intval($organisation->show_currency_code)) }}

    @include('organisations.nav', ['selected' => ORGANISATION_LOCALIZATION])
