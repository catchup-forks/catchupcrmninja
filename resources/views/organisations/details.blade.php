...
@section('content')	
    ...
    @include('organisations.nav', ['selected' => ORGANISATION_COMPANY_DETAILS])
	...
	<div class="row">
            ...
            <div class="panel-body form-padding-right">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <a href="/{{ $organisation->getLogoPath().'?no_cache='.time() }}" target="_blank">
                            {!! HTML::image($organisation->getLogoPath().'?no_cache='.time(), 'Logo', ['max-width' => 200]) !!}
                        </a> &nbsp;
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            ...
            {!! Former::text('housenumber')->autocomplete('address-line2') !!}
