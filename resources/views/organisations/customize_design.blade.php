...
@section('content')	
  ...
  <script>
    ...
    function getPDFString(cb, force) {
      ...
      invoice.organisation.hide_quantity = {!! Auth::user()->organisation->hide_quantity ? 'true' : 'false' !!};
      invoice.organisation.hide_paid_to_date = {!! Auth::user()->organisation->hide_paid_to_date ? 'true' : 'false' !!};
      invoice.invoice_design_id = {!! Auth::user()->organisation->invoice_design_id !!};

      NINJA.primaryColor = '{!! Auth::user()->organisation->primary_color !!}';
      NINJA.secondaryColor = '{!! Auth::user()->organisation->secondary_color !!}';
      NINJA.fontSize = {!! Auth::user()->organisation->font_size !!};
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      {!! Former::populateField('invoice_design_id', $organisation->invoice_design_id) !!}
