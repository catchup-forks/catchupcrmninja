...
@section('content')
  ...
  {!! Former::populateField('enable_customer_portal', intval($organisation->enable_customer_portal)) !!}
  ...
  @if (!Utils::isNinja() && !Auth::user()->organisation->isWhiteLabel())
  ...
  @include('organisations.nav', ['selected' => ORGANISATION_CUSTOMER_PORTAL])

  <div class="row">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title">{!! trans('texts.CUSTOMER_PORTAL') !!}</h3>
      </div>
      <div class="panel-body">
        <div class="col-md-10 col-md-offset-1">
          {!! Former::checkbox('enable_customer_portal')
            ->text(trans('texts.enable'))
            ->help(trans('texts.enable_customer_portal_help')) !!}
        </div>
        <div class="col-md-10 col-md-offset-1">
