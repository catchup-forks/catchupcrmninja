...
<head>
    ...
    <!--[if !mso]><!-- -->
    <link href="{{ isset($organisation) ? $organisation->getFontsUrl('http') : '' }}" rel="stylesheet" type="text/css" />
    <!--<![endif]-->
</head>
<body style="min-height: 700px; color: #000000;{!! isset($organisation) ? $organisation->getBodyFontCss() : '' !!}font-size: 12px; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; background: #F4F5F5; margin: 0; padding: 0;"
    ...
    <div id="body_style" style="min-height: 700px;{!! isset($organisation) ? $organisation->getBodyFontCss() : '' !!};color: #2E2B2B; font-size: 16px;
